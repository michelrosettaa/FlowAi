...
export async function getGmailClient(userId: string, provider: 'google' | 'microsoft-entra-id' = 'google') {
  if (provider === 'google') {
    ...
    throw new Error('Microsoft Graph mail not yet implemented - coming soon');
  } else {
