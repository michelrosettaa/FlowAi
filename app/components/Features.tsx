export default function Features() {
  return (
    <section id="features" className="py-20 bg-white text-center">
      <h2 className="text-3xl font-bold text-gray-900 mb-10">Why teams love Refraim AI</h2>
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto px-8">
        ...
        <div className="p-6 rounded-2xl shadow-md hover:shadow-xl transition">
          ...
          <p className="text-gray-600">Learn your most productive hours and let Refraim AI optimize your daily schedule around them.</p>
        </div>
      </div>
    </section>
  );
